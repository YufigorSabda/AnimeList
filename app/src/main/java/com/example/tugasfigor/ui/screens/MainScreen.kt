...
import com.example.tugasfigor.ui.components.NavItem
import com.example.tugasfigor.ui.pages.AboutPage
import com.example.tugasfigor.ui.pages.AnimePage
import com.example.tugasfigor.ui.pages.HomePage
        ...
        topBar = {
            TopAppBar(
                ...
                colors = TopAppBarDefaults.smallTopAppBarColors(
                    containerColor = Color(0xFF25043d), // Set background color here
...
fun ContentScreen(modifier: Modifier = Modifier, selectedIndex: Int, navController: NavController) {
    when (selectedIndex) {
        ...
        1 -> AnimePage(modifier = modifier, navController = navController)
